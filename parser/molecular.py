...
#     return parser.common.load_parsed_data(parsed_folder,'Global')
#  else:
#    print 'Parsing data'
#    X,y = parser.common.parse_molecular_data(molec_file, property_file,\
#                        descriptor, atomic_cut_off, larger_mol)
#
#    print "- Parced",len(y[1:]), "molecules"
#
#    if load_parsed==False: #and dev_mode==False:
#        parser.common.save_parsed_data(X,y,parsed_folder,'Global')
